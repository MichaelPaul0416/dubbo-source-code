...
public final class ExecutionList {
    ...
    public void add(Runnable runnable, Executor executor) {
        ...
        synchronized (this) {
            if (!executed) {// 相当于注册，这段代码的意思就是如果当前有人在执行的话，那么就加到链表头部，等待执行
                runnables = new RunnableExecutorPair(runnable, executor, runnables);// 形成链表
                return;
            }
        }
    ...
    public void execute() {
        ...
        // 找到链表末尾，并且reversedList代表原先链表的逆序
        while (list != null) {
