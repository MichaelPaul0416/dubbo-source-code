...
import org.apache.dubbo.common.extensionloader.adaptive.impl.HasAdaptiveExt_ManualAdaptive;
import org.apache.dubbo.common.extensionloader.ext1.SimpleExt;
import org.apache.dubbo.common.extensionloader.ext2.Ext2;
...
import org.apache.dubbo.common.extensionloader.ext6_inject.impl.Ext6Impl2;
...
public class ExtensionLoader_Adaptive_Test {
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNoAdaptiveMethodOnInterface() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    allOf(containsString("Can not create adaptive extension interface org.apache.dubbo.common.extensionloader.ext5.NoAdaptiveMethodExt"),
                            containsString("No adaptive method on extension org.apache.dubbo.common.extensionloader.ext5.NoAdaptiveMethodExt, refuse to create the adaptive class")));
        }
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNotAdaptiveMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface org.apache.dubbo.common.extensionloader.ext1.SimpleExt is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_UrlNpe() throws Exception {
        ...
        try {
            ...
            assertEquals("org.apache.dubbo.common.extensionloader.ext2.UrlHolder argument == null", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("org.apache.dubbo.common.extensionloader.ext2.UrlHolder argument getUrl() == null", e.getMessage());
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNotAdativeMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface org.apache.dubbo.common.extensionloader.ext2.Ext2 is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNameNotProvided() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Fail to get extension(org.apache.dubbo.common.extensionloader.ext2.Ext2) name from url"));
        }
    }
