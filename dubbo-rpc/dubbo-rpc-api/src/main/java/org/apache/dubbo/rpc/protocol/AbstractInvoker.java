...
public abstract class AbstractInvoker<T> implements Invoker<T> {
    ...
    public Result invoke(Invocation inv) throws RpcException {
        ...
        invocation.setInvoker(this);//委托给真正的Invoker，Invocation其实就是有点类似于自定义协议栈中的传输数据封装对象
        ...
        if (getUrl().getMethodParameter(invocation.getMethodName(), Constants.ASYNC_KEY, false)) {//是否异步
